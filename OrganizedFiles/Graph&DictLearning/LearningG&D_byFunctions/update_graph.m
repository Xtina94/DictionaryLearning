function [param, learned_W] = update_graph(x, alpha, beta, maxEpoch, param,learned_dictionary, learned_W) 
...
%     [learned_dictionary, param] = construct_dict(param);
    ...
    %eigenDecomposition
    [eigenVal, eigenMat] = eig(param.Laplacian);
    param.lambda_sym = sort(diag(eigenVal));
