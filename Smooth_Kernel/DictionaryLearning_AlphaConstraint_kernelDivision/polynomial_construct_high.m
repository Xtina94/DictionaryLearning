function alpha_coefficients_high = polynomial_construct_high(param)
...
beta = param.beta_coefficients_high;
...
if param.S == 4
    ...
    alpha_coefficients_high = [alpha_1' alpha_2' alpha_3' alpha_4']';
else
    alpha_coefficients_high = [alpha_1' alpha_2']';
end
end
