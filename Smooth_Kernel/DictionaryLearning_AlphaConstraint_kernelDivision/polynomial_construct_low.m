function alpha_coefficients_low = polynomial_construct_low(param)
...
beta = param.beta_coefficients_low;
...
if param.S == 4
    ...
    alpha_coefficients_low = [alpha_1' alpha_2' alpha_3' alpha_4']';
else
    alpha_coefficients_low = [alpha_1' alpha_2']';
end
end
