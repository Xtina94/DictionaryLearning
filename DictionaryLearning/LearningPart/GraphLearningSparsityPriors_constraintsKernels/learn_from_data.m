...
close all
addpath(genpath(pwd))
path = 'C:\Users\Cristina\Documents\GitHub\DictionaryLearning\LearningPart\GraphLearningSparsityPriors_constraintsKernels\';
...
for repetitions = 1:1
    ...
    switch flag
        ...
        case 3
            ...
            param.percentage = 8;
            param.epsilon = 0.7; %0.02; % we assume that epsilon_1 = epsilon_2 = epsilon
        case 4
