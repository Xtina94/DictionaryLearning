\section{Representing a graph: graph learning techniques and dictionary representation}
...
\subsection{The correspondence between the dictionary and the graph signal}
